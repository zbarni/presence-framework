...
public class ComponentSubscription {
     ...
     */
    public ComponentSubscription(String aForm, String aTo, String aContact, String aBody, String aMimeType,
    ...
    public String getRemoteNumber() {
        if (ComponentSubscription.SELF.equalsIgnoreCase(from)) {
            return to;
        }else {
            return from;
        }
    ...
    public String getErrorContent() {
        if (status == ComponentSubscription.STATUS_NONE
